...
function clearCurrentSessionView(){S.currentSessionId=null;S.turns=[];S.pendingById={};S.itemByClientId={};S.traceByClientId={};S.turnStateByClientId={};S.historyLoaded=false;S.renderedTurnCount=0}
...
S.pendingById['m2']={id:'m2',text:'next',state:'accepted',serverPhase:'queued',ts:2}
