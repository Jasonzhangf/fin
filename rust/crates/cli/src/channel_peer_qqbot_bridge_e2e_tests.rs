...
fn qqbot_inbound_message_runs_end_to_end_and_emits_reply_from_session_truth() {
    let response_body = r#"{"id":"msg-qqbot-1","content":[{"type":"text","text":"<fin_user_response>闭环回复：收到 Jason。</fin_user_response>\n<fin_control_feedback>{\"origin\":\"model_output_contract_v1\",\"is_continuation\":true,\"is_simple_query\":false,\"task_completed\":true,\"is_simple_chat\":false,\"blocked\":false,\"needs_user_involve\":false,\"candidate_task_id\":\"task-qqbot\",\"candidate_topic_thread_id\":\"topic-qqbot\",\"continuity_confidence\":92,\"topic_shift_confidence\":8,\"simple_query_confidence\":4,\"previous_topic_summary\":\"qqbot e2e\",\"current_topic_summary\":\"qqbot e2e\",\"completion_evidence\":[\"qqbot inbound processed\",\"session reply persisted\"],\"final_conclusions\":[\"qqbot e2e closure completed\",\"channel reply sent from session truth\"],\"blocked_reason\":null,\"what_needs_to_be_done_by_user\":null,\"note_candidate\":\"qqbot e2e done\",\"digest_candidate\":\"qqbot e2e done\",\"reason\":\"reply ready\"}</fin_control_feedback>\n<fin_tool_calls>[{\"tool_name\":\"reasoning.stop\",\"arguments\":{\"summary\":\"qqbot e2e done\"}}]</fin_tool_calls>"}],"stop_reason":"end_turn"}"#;
...
fn qqbot_inbound_restores_existing_target_session_and_continues_same_session() {
    let first_response = r#"{"id":"msg-qqbot-2","content":[{"type":"text","text":"<fin_user_response>第一次回复。</fin_user_response>\n<fin_control_feedback>{\"origin\":\"model_output_contract_v1\",\"is_continuation\":true,\"is_simple_query\":false,\"candidate_task_id\":\"task-restore\",\"candidate_topic_thread_id\":\"topic-restore\",\"continuity_confidence\":90,\"topic_shift_confidence\":10,\"simple_query_confidence\":5,\"previous_topic_summary\":\"restore\",\"current_topic_summary\":\"restore\",\"is_simple_chat\":true,\"note_candidate\":\"first reply\",\"digest_candidate\":\"first reply\",\"reason\":\"first turn\"}</fin_control_feedback>\n<fin_tool_calls>[{\"tool_name\":\"reasoning.stop\",\"arguments\":{\"summary\":\"first turn done\"}}]</fin_tool_calls>"}],"stop_reason":"end_turn"}"#;
    let second_response = r#"{"id":"msg-qqbot-3","content":[{"type":"text","text":"<fin_user_response>第二次回复，沿用旧会话。</fin_user_response>\n<fin_control_feedback>{\"origin\":\"model_output_contract_v1\",\"is_continuation\":true,\"is_simple_query\":false,\"candidate_task_id\":\"task-restore\",\"candidate_topic_thread_id\":\"topic-restore\",\"continuity_confidence\":94,\"topic_shift_confidence\":6,\"simple_query_confidence\":4,\"previous_topic_summary\":\"restore\",\"current_topic_summary\":\"restore\",\"is_simple_chat\":true,\"note_candidate\":\"restored existing target session\",\"digest_candidate\":\"restored existing target session\",\"reason\":\"existing target binding wins\"}</fin_control_feedback>\n<fin_tool_calls>[{\"tool_name\":\"reasoning.stop\",\"arguments\":{\"summary\":\"second turn done\"}}]</fin_tool_calls>"}],"stop_reason":"end_turn"}"#;
    ...
    assert_eq!(
        outbound[3]["payload"]["text"].as_str(),
        Some("第二次回复，沿用旧会话。")
    );
