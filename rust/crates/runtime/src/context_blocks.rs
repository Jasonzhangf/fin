...
pub(super) fn build_project_block(
    ...
    ProjectContextBlock {
        ...
        task_status_counts: task_board.task_status_counts,
        ready_task_ids: task_board.ready_task_ids,
        submitted_task_ids: task_board.submitted_task_ids,
        owner_loop_summary: task_board.owner_loop_summary,
