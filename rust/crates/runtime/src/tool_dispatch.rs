...
#[derive(Debug, Clone)]
pub(super) struct ToolDispatchInput<'a> {
...
pub(super) fn execute_model_tools(
    operation_id: &str,
    trace_id: &str,
    refs: &EntityRefs,
    occurred_at: &str,
...
pub(super) fn read_string(arguments: &Value, key: &str) -> Option<String> {
...
pub(super) fn read_u64(arguments: &Value, key: &str) -> Option<u64> {
    let object = arguments.as_object()?;
...
pub(super) fn read_bool(arguments: &Value, key: &str) -> Option<bool> {
    let object = arguments.as_object()?;
...
pub(super) fn short_text(value: &str, limit: usize) -> String {
